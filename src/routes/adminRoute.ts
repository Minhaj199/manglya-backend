...
import { AdminController } from "../controller/implimentation/adminController.ts";
...
router.patch(
  ...
  adminController.sendWarningMails
);
router.patch(
  "/blockAbuser/:id",
  adminJwtAuthenticator,
  dtoValidate(reportAbuseActionDtoSchema),
  adminController.blockAbuser
);
...
router.patch(
  ...
  adminController.rejecReport
);
router.patch(
  "/reportToggle/:id",
  adminJwtAuthenticator,
  dtoValidate(abuseMessageToggleShema),
  adminController.reportToggle
);
router.delete(
  "/deleteMsg/:id",
  adminJwtAuthenticator,
  adminController.deleteMsg
);
