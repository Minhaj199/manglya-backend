...
import { IFeatures, IInterestInput,  IInterestInterface,  IPlanOrder,  IPlanOrders,  IRefeshToken,  IRefreshWithPopulatedData,  PlanOrderMongo, } from "../../types/TypesAndInterfaces.ts"
...
export interface IOtherRepositories{
    ...
    getInterestAsCategory():Promise<IInterestInterface|null>
...
export interface IRefreshToken{
    ...
    fetchToken(extractId:string,refreshToken:string): Promise<IRefreshWithPopulatedData|null>
